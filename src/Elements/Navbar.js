...
const Navbar = () => {
    ...
    const uploadPic = async (e) => {
        ...
        axios.post('https://backend-kappa-murex.vercel.app/api/auth/uploadPic',formData,axiosConfig)
        .then(async (res)=>{
            ...
            <div id='navMainDiv'>
                ...
                <div id='profileDiv'>
                    
                    {
                        user?(
                            <>
                                ...
                                <ul id='profileMenuUl'>
                                    ...
                                    <ul id='profileUl'>
                                        <li><span id='profileUlSpan' onClick={onUpdateProfile}><i class="fa-solid fa-arrow-right"></i> Back </span></li>
                                        <li>Basic Info</li>
                        ...
                        :
                        (
                        <span id='profileSpan' onClick={navigationFun}>
